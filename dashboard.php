    ...
    <div class="row">
      <div class="col-lg-3">
        ...
        <div>
          ...
          <p class="fs-0.5"><span></span>Podcasts</p>
          <p class="fs-0.5"><span></span>Videos</p>
          <p class="fs-0.5"><span></span>Tags</p>
          <p class="fs-0.5"><span></span>Dev Education Tracks</p>
          <p class="fs-0.5"><span></span>Dev Challenges</p>
          <p class="fs-0.5"><span></span>Dev Challenges</p>
          <p class="fs-0.5"><span></span>Advertise on DEV</p>
          <p class="fs-0.5"><span></span>DEV Showcase</p>
          <p class="fs-0.5"><span></span>About</p>
          <p class="fs-0.5"><span></span>Contact</p>
          <p class="fs-0.5"><span></span>Free Postgres Database</p>
          <p class="fs-0.5"><span></span>Software Comparisons</p>
